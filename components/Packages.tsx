...
const itineraries: Itinerary[] = [
  ...
  },
  {
    ...
    destinations:["Dal Lake","Gulmarg"],
    highlights:["Houseboat stay on Dal Lake","Shikara at sunrise","Gulmarg day trip","Mughal Gardens"],
    includes:["Houseboat","Meals","Cab","Gondola (Phase I)","Guide"],
    dayPlan:[
      { day:1, title:"Dal Lake Magic",            places:"Srinagar · Houseboat",    desc:"Arrive, houseboat check-in, sunset shikara on Dal Lake." },
      { day:2, title:"Srinagar City Tour",        places:"Srinagar",                desc:"Mughal Gardens, old city bazaar, floating vegetable market at dawn." },
      { day:3, title:"Gulmarg Day Trip",          places:"Gulmarg",                 desc:"Gondola to Kongdori, snow play, return for dinner on the lake." },
      { day:4, title:"Farewell Morning",          places:"Dal Lake · Airport",      desc:"Last shikara ride, souvenir shopping, airport departure." },
    ],
  },
  {
    id:"sacred-kashmir",
