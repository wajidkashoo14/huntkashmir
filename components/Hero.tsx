    ...
    <section id="home" ref={sectionRef} className="relative w-full min-h-screen overflow-hidden flex flex-col">
      ...
      >
        ...
        <motion.div initial={{ opacity:0, y:30 }} animate={{ opacity:1, y:0 }} transition={{ delay:0.4, duration:0.6 }}
          ...
          <a href="#packages" className="btn-gold px-7 py-3.5 rounded-full font-bold text-[#1B4332] text-sm sm:text-base shadow-xl text-center">
            Explore Packages
          </a>
          <a href="#destinations" className="px-7 py-3.5 rounded-full font-bold text-white text-sm sm:text-base border-2 border-white/50 hover:bg-white/15 transition-all text-center">
            View Destinations
          </a>
        </motion.div>
        ...
        >
          ...
          <div className="bg-[#0a1612]/80 backdrop-blur-2xl border border-white/20 rounded-2xl sm:rounded-3xl p-3 sm:p-4 shadow-[0_8px_64px_rgba(0,0,0,0.7)] ring-1 ring-white/5">
            ...
            >
              ...
              {plannerComplete ? "Plan My Kashmir Trip →" : "Select destination & month to continue"}
            </motion.button>
