          ...
          <div className="bg-[#0a1612]/80 backdrop-blur-2xl border border-white/20 rounded-2xl sm:rounded-3xl p-3 sm:p-4 shadow-[0_8px_64px_rgba(0,0,0,0.7)] ring-1 ring-white/5">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-3">
              <button
                ...
                className={`relative flex flex-col items-start gap-0.5 px-3 sm:px-4 py-3 sm:py-3.5 rounded-xl sm:rounded-2xl border transition-all duration-200 text-left cursor-pointer ${open === "dest" ? "bg-white/25 border-[#C9A84C]" : "bg-white/12 border-white/20 hover:bg-white/22 hover:border-[#C9A84C]/50"
                  }`}
              >
              ...
              <button
                ...
                className={`relative flex flex-col items-start gap-0.5 px-3 sm:px-4 py-3 sm:py-3.5 rounded-xl sm:rounded-2xl border transition-all duration-200 text-left cursor-pointer ${open === "date" ? "bg-white/25 border-[#C9A84C]" : "bg-white/12 border-white/20 hover:bg-white/22 hover:border-[#C9A84C]/50"
                  }`}
              >
                <div className="flex items-center gap-1.5 w-full">
              ...
              <button
                ...
                className={`relative flex flex-col items-start gap-0.5 px-3 sm:px-4 py-3 sm:py-3.5 rounded-xl sm:rounded-2xl border transition-all duration-200 text-left cursor-pointer ${open === "travelers" ? "bg-white/25 border-[#C9A84C]" : "bg-white/12 border-white/20 hover:bg-white/22 hover:border-[#C9A84C]/50"
                  }`}
              >
                <div className="flex items-center gap-1.5 w-full">
                  ...
                  <div className="grid grid-cols-3 gap-2 pt-1">
                    {DESTINATIONS.map((d) => (
                      <motion.button
                        ...
                        className={`relative overflow-hidden rounded-xl aspect-[3/2] group cursor-pointer border-2 transition-all duration-200 ${selDest?.id === d.id ? "border-[#C9A84C]" : "border-transparent"
                          }`}
                      >
                  ...
                  <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
                    {upcomingMonths.map((m) => (
                      <motion.button
                        ...
                        className={`relative rounded-xl py-2.5 px-2 text-center border transition-all duration-200 cursor-pointer ${selMonth?.month === m.month && selMonth?.year === m.year
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-3">
                    {TRAVELER_TYPES.map((t) => (
                      <button
                        ...
                        className={`rounded-xl py-2 px-1 text-center border transition-all duration-200 cursor-pointer ${selTravType.id === t.id
                            ? "bg-[#C9A84C] border-[#C9A84C] text-[#1B4332]"
            ...
            <motion.button
              ...
              className={`w-full py-3.5 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base flex items-center justify-center gap-2 transition-all duration-300 cursor-pointer ${plannerComplete
