...
import { MapPin, Phone, Mail, Clock, Send, CheckCircle, AlertCircle, Loader2, Users, Calendar, MessageSquare } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setForm({
        ...
        travel_date: "", return_date: "", travelers: "2",
        trip_type: "", package: "", budget: "", message: "",
      });
    } catch {
      setStatus("error");
    }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <AnimateOnScroll direction="up" className="text-center mb-12 sm:mb-16">
          ...
          <p className="mt-4 sm:mt-6 text-gray-500 text-base sm:text-lg max-w-2xl mx-auto">
            Fill in your details and our Kashmir travel experts will craft a personalised itinerary and get back to you within 2 hours.
          </p>
        </AnimateOnScroll>
          ...
          <div className="lg:col-span-2 space-y-4">
            <StaggerContainer stagger={0.1} className="space-y-4">
              {contactDetails.map((c, i) => (
                <StaggerChild key={i} direction="left">
                  <motion.div
                    whileHover={{ x: 4, boxShadow: "0 8px 24px rgba(0,0,0,0.07)" }}
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <p className="font-bold text-[#1B4332] mb-1.5 text-sm">{c.title}</p>
                      {c.lines.map((line, j) => (
                        <p key={j} className="text-gray-600 text-sm leading-snug">{line}</p>
                      ))}
                      {c.link && (
                        <a
                          href={c.link}
            ...
            <StaggerChild direction="up">
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.02, boxShadow: "0 12px 32px rgba(37,211,102,0.25)" }}
                whileTap={{ scale: 0.98 }}
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm mt-0.5">Fastest reply — usually within minutes</p>
                </div>
              </motion.a>
            </StaggerChild>
          </div>
          ...
          <AnimateOnScroll direction="right" className="lg:col-span-3">
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-3 mb-7">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#0F1923]">Send Us Your Requirements</h3>
                  <p className="text-gray-400 text-xs mt-0.5">We reply within 2 hours · Free consultation</p>
                </div>
              </div>
              ...
              <AnimatePresence mode="wait">
                {status === "success" ? (
                  ...
                  >
                    ...
                    <h4 className="text-xl font-bold text-[#1B4332] mb-2">Message Sent!</h4>
                    <p className="text-gray-500 text-sm max-w-xs mx-auto mb-6">
                      Thank you! Our Kashmir travel expert will call you back within 2 hours.
                    </p>
                    <button
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          name="from_email" value={form.from_email} onChange={handleChange}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            required type="tel" placeholder="9XXXXXXXXX"
                      ...
                      <div>
                        ...
                        <select name="travelers" value={form.travelers} onChange={handleChange} className={inputCls}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select name="destination" value={form.destination} onChange={handleChange} className={inputCls}>
                      ...
                      <div>
                        ...
                        <select name="trip_type" value={form.trip_type} onChange={handleChange} className={inputCls}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          name="travel_date" value={form.travel_date} onChange={handleChange}
                      ...
                      <div>
                        ...
                        <input
                          name="return_date" value={form.return_date} onChange={handleChange}
                          type="date" min={form.travel_date || new Date().toISOString().split("T")[0]}
                          className={inputCls}
                        />
                      </div>
                    </div>
